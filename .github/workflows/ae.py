...
concurrency:
  group: ae-repo-update  # Make this unique per workflow
...
jobs:
  fetch_data:
    ...
    env:
      ...
      SCRIPT_NAME: ae.py
      OUTPUT_FILE: ae.json
      ENRICHED_FILE: ae-enriched.json
      ...
      - name: Run Script, Commit and Push with Retry
        run: |
          ...
          while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
            ...
            # Re-run the script to generate fresh data
            python $SCRIPT_NAME
            ...
            if [ $RETRY_COUNT -lt $MAX_RETRIES ]; then
              # Add exponential backoff with jitter to avoid collisions
